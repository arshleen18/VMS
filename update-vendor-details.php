...
<body>
    ...
    <div class="container" style="max-width: 800px;">
        ...
        <form action="update-vendor-details.php" method="post">
            ...
            <div class="form-group">
                Tender Fees
                <input type="text" class="form-control" name="tender_fees">
            </div>
            <div class="form-btn">
                <input type="submit" class="btn btn-primary" value="Submit" name="submit">
            </div>
            <a href="update-vendor.html">Back</a>
        </form>
    </div>
</body>
</html>